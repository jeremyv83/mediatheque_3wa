 ...
 */
final class Version20220303114448 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE rencontre (id INT AUTO_INCREMENT NOT NULL, auteur_id INT NOT NULL, date DATE NOT NULL, title VARCHAR(255) NOT NULL, INDEX IDX_460C35ED60BB6FE6 (auteur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE rencontre ADD CONSTRAINT FK_460C35ED60BB6FE6 FOREIGN KEY (auteur_id) REFERENCES auteur (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE rencontre DROP FOREIGN KEY FK_460C35ED60BB6FE6');

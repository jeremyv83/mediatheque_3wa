 ...
 */
final class Version20220301105621 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT AUTO_INCREMENT NOT NULL, author_id INT NOT NULL, document_id INT NOT NULL, text LONGTEXT NOT NULL, INDEX IDX_9474526CF675F31B (author_id), INDEX IDX_9474526CC33F7837 (document_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE document (id INT AUTO_INCREMENT NOT NULL, auteur_id INT DEFAULT NULL, document_type_id INT DEFAULT NULL, name VARCHAR(255) NOT NULL, quantity INT NOT NULL, physique TINYINT(1) NOT NULL, fragile TINYINT(1) NOT NULL, description VARCHAR(5000) NOT NULL, date DATE NOT NULL, INDEX IDX_D8698A7660BB6FE6 (auteur_id), INDEX IDX_D8698A7661232A4F (document_type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE emprunt (id INT AUTO_INCREMENT NOT NULL, document_id INT NOT NULL, user_id INT NOT NULL, date_emprunt DATE NOT NULL, date_remise DATE NOT NULL, etat_remise INT NOT NULL, INDEX IDX_364071D7C33F7837 (document_id), INDEX IDX_364071D7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE logs (id INT AUTO_INCREMENT NOT NULL, documents_id INT DEFAULT NULL, actions VARCHAR(255) NOT NULL, INDEX IDX_F08FC65C5F0F2752 (documents_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE rencontre (id INT AUTO_INCREMENT NOT NULL, date DATE NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');

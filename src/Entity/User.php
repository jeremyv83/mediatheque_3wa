...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Rencontre::class, mappedBy="participants")
     */
    private $rencontres;


    /**
     * @ORM\ManyToMany(targetEntity=Document::class, inversedBy="reserved_by")
     * @JoinTable(name="reserved")
     */
    private $reserved;

    /**
     * @ORM\ManyToMany(targetEntity=Document::class, inversedBy="recommanded_by")
     * @JoinTable(name="recommandations")
     */
    ...
    public function removeRencontre(Rencontre $rencontre): self
    {
        if ($this->rencontres->removeElement($rencontre)) {
            $rencontre->removeParticipant($this);
        }
    ...
    public function addReserved(Document $reserved): self
    {
    ...
    public function removeReserved(Document $reserved): self
    {
        $this->reserved->removeElement($reserved);
    ...
    public function addRecommandation(Document $recommandation): self
    {
    ...
    public function removeRecommandation(Document $recommandation): self
    {
